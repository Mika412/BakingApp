package com.example.mykha.bakingmaster.fragment;
...
import com.example.mykha.bakingmaster.adapter.IngredientsAdapter;
import com.example.mykha.bakingmaster.adapter.StepsAdapter;
import com.example.mykha.bakingmaster.data.Ingredient;
import com.example.mykha.bakingmaster.data.Recipe;
import com.example.mykha.bakingmaster.data.Step;
...
public class RecipeDetailsFragment extends Fragment implements StepsAdapter.StepOnClickHandler {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        IngredientsAdapter ingredientAdapter = new IngredientsAdapter(getContext(), ingredients);
        recyclerViewIngredients.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerViewIngredients.setAdapter(ingredientAdapter);

        stepAdapter = new StepsAdapter(getContext(), steps, this);
    ...
    public StepsAdapter getStepAdapter() {
        return stepAdapter;
    }
